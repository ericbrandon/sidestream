...
import type { Message, Attachment, Citation, InlineCitation, GeneratedFile, ModelSwitch } from '../lib/types';
...
interface ChatState {
  ...
  streamingModelSwitch: ModelSwitch | null; // Set if the requested model (Fable 5 / Opus 5) refused and a fallback answered this turn (may chain)
  ...
  setStreamingModelSwitch: (modelSwitch: ModelSwitch) => void;
  ...
  loadSessionWithStreaming: (
    ...
    streamingModelSwitch?: ModelSwitch | null
  ) => void;
...
export const useChatStore = create<ChatState>((set, get) => ({
  ...
  setStreamingModelSwitch: (modelSwitch) => set({ streamingModelSwitch: modelSwitch }),
      ...
      messages: [
        ...state.messages,
        {
          ...
          generatedFiles: state.streamingGeneratedFiles.length > 0
            ? state.streamingGeneratedFiles
            : undefined,
          modelSwitch: state.streamingModelSwitch ?? undefined,
        },
      ],
      streamingContent: '',
      streamingCitations: [],
  ...
  loadSessionWithStreaming: (
    ...
    streamingGeneratedFiles: GeneratedFile[] = [],
    streamingModelSwitch: ModelSwitch | null = null
  ) =>
    set({
      messages,
      inputValue: '',
